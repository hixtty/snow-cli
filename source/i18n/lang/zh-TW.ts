...
export const zhTW: TranslationKeys = {
	...
	proxyConfig: {
		...
		hostValidationError: '主機必須是有效的 IP 位址或網域名稱',
		notSet: '未設定',
	...
	codebaseConfig: {
		...
		agentReviewModel: '審查模型:',
		agentReviewModelLlm: 'LLM(基礎模型)',
		enabled: '[✓] 已啟用',
		disabled: '[ ] 已停用',
		toggleHint: '(按 Enter 切換)',
		embeddingType: '請求類型:',
	...
	configScreen: {
		...
		scopeSelectTitle: 'API 和模型配置',
		scopeSelectSubtitle: '選擇要配置的內容：LLM 模型，或獨立的決策模型',
		llmConfigEntry: '配置 LLM 模型',
		llmConfigEntrySubtitle: 'API 連接、請求方案、模型、推理參數、令牌與逾時',
		scopeSelectHint: '↑↓ 選擇 · Enter 進入 · Esc 返回',
		decisionModelConfig: '決策模型配置',
		decisionModelConfigSubtitle:
			'管理獨立的決策模型（可設定多個，同一時間僅一個生效）',
	},
	// Decision Models Screen
	decisionModels: {
		title: '決策模型',
		subtitle: '管理獨立的決策模型（可設定多個，同一時間僅一個生效）',
		activeModel: '目前啟用:',
		none: '無',
		noModelsConfigured: '尚未設定任何決策模型',
		availableModels: '可用決策模型',
		actions: '操作',
		activate: '啟用',
		deactivate: '取消啟用',
		edit: '編輯',
		...
		addNew: '+ 新增',
		escBack: 'Esc 返回',
		navigationHint: '↑↓ 導覽 · ←→ 切換操作 · Enter 確認 · Esc 返回',
		addNewTitle: '新增決策模型',
		editTitle: '編輯決策模型',
		nameLabel: '名稱:',
		namePlaceholder: '例如: Jev (OpenRouter)',
		baseUrlLabel: 'Base URL:',
		baseUrlModeLabel: 'Base URL 模式:',
		apiKeyLabel: 'APIKey:',
		modelLabel: '模型 ID:',
		untitled: '未命名模型',
		notSet: '未設定',
		editingHint: '↑↓ 切換欄位 · Enter 編輯 · Ctrl+S 儲存 · Esc 返回',
		selectHint: '↑↓ 選擇 · Enter 確認',
		confirmDelete: '刪除決策模型',
		deleteConfirmMessage: '確定要刪除',
		confirmHint: '按 Y 確認，按 N 或 Esc 取消',
		saveError: '儲存決策模型配置失敗',
	},
	customHeaders: {
		title: '自訂請求頭管理',
	...
	commandPanel: {
		...
		commands: {
			...
			cleanup: '清理 ~/.snow 資料：依專案或依時間刪除會話、快照、日誌等',
	...
	cleanupPanel: {
		title: '清理 ~/.snow 資料',
		loading: '正在掃描磁碟佔用...',
		totalUsage: '目前總佔用: {size}',
		menu: {
			byProject: '依專案清理（會話、快照等）',
			byAge: '依時間清理（日誌、用量、舊資料）',
		},
		menuHint: '↑↓ 選擇 • Enter 進入 • ESC 關閉',
		byProjectHint:
			'↑↓ 導航 • 空格 標記/取消 • A 全選/全不選 • D 刪除已標記 • ESC 返回',
		noProjects: '未找到專案資料',
		markedProjects: '已標記 {count} 個專案待刪除',
		byAgeHint: '↑↓ 選擇天數 • D 刪除早於所選天數的資料 • ESC 返回',
		olderThan: '早於 {days} 天',
		filesCount: '{count} 個檔案',
		ageIncludes: '包含: 日誌、用量統計、任務、匯出、會話、快照、歷史、TODO 等',
		ageSelected: '已選擇: 早於 {days} 天 • 約 {size} 可清理',
		confirmTitle: '確認清理',
		confirmProjects: '確定刪除 {count} 個專案的全部資料嗎？{names}',
		confirmAge: '確定刪除早於 {days} 天的全部資料嗎（約 {size}）？',
		confirmHint: 'Y 確認, N 取消',
		deleting: '正在清理中...',
		resultTitle: '清理完成',
		resultSummary: '已刪除 {files} 個檔案，釋放 {size}',
		resultErrors: '發生 {count} 個錯誤:',
		resultHint: '按任意鍵返回選單',
		categories: {
			sessions: '會話',
			snapshots: '快照',
