...
export const en: TranslationKeys = {
	...
	proxyConfig: {
		...
		hostValidationError: 'Host must be a valid IP address or hostname',
		notSet: 'Not set',
	...
	codebaseConfig: {
		...
		agentReviewModelLlm: 'LLM (Basic Model)',
		enabled: '[✓] Enabled',
		disabled: '[ ] Disabled',
		toggleHint: '(Press Enter to toggle)',
	...
	configScreen: {
		...
		scopeSelectTitle: 'API & Model Configuration',
		scopeSelectSubtitle:
			'Choose what to configure: the LLM model, or the independent decision models',
		llmConfigEntry: 'Configure LLM Model',
		llmConfigEntrySubtitle:
			'API connection, request method, models, reasoning, token & timeout',
		scopeSelectHint: '↑↓ Select · Enter Open · Esc Back',
		decisionModelConfig: 'Decision Models',
		decisionModelConfigSubtitle:
			'Manage independent decision models (multiple entries, only one active)',
	},
	...
	decisionModels: {
		...
		none: 'None',
		noModelsConfigured: 'No decision models configured',
		availableModels: 'Available decision models',
		actions: 'Actions',
		activate: 'Activate',
		...
		addNew: '+ Add new',
		escBack: 'Esc Back',
		navigationHint: '↑↓ Navigate · ←→ Switch action · Enter Confirm · Esc Back',
		addNewTitle: 'Add Decision Model',
		editTitle: 'Edit Decision Model',
		nameLabel: 'Name:',
		namePlaceholder: 'e.g. Jev (OpenRouter)',
		baseUrlLabel: 'Base URL:',
		baseUrlModeLabel: 'Base URL Mode:',
		apiKeyLabel: 'API Key:',
		modelLabel: 'Model ID:',
		untitled: 'Unnamed Model',
		notSet: 'Not set',
		editingHint: '↑↓ Switch field · Enter edit · Ctrl+S save · Esc back',
		selectHint: '↑↓ Select · Enter Confirm',
		confirmDelete: 'Delete decision model',
		deleteConfirmMessage: 'Are you sure you want to delete',
		confirmHint: 'Press Y to confirm, N or Esc to cancel',
		saveError: 'Failed to save decision models configuration',
	},
	customHeaders: {
